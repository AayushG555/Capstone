...
# Function to determine which Python file to run based on user input and capture output
        ...
        if input_text.strip().lower() == text_file_contents:
            ...
            if module_spec:
                ...
                if hasattr(module, "main") and callable(module.main):
                    return module.main(input_text)  # Pass input_text to main function
                else:
